            ...
            <table class="header-table">
                <tr>
                    <td class="center title" style="padding-top: 20px;">
                        HOJA DE SERVICIO ADMINISTRACIÓN DE PERSONAL 
                    </td>
                </tr>
                <tr>
                    ...
                    <td width="84%">
                        ...
                        <table style="width:100%;" class="input-text">
                            ...
                            <tr>
                                ...
                                <td width="5%"></td>
                                <td width="20%" class="pt-1 border-b">0000000</td>
                                <td width="5%"></td>
                                <td width="20%" class="pt-1 border-b">AAAA0000000AA0</td>                            
                            </tr>
                        </table>
                        ...
                        <table style="width:100%;" class="input-text pt-2">
                            <tr class="blue-text">
                                ...
                                <td width="20%">Loc</td>
                                <td width="5%"></td>
                                <td width="45%">Entidad de nacimiento</td>                            
                            </tr>
                            <tr>
                                ...
                                <td width="5%"></td>
                                <td width="45%" class="pt-1 border-b">Entidad</td>                            
                            </tr>
                        </table>
                        <!-- Información personal 3 -->
                        <table style="width:100%;" class="input-text pt-2">
                            <tr class="blue-text">
                                <td width="20%">Licencia tipo "E"</td>
                                <td width="5%"></td>
                            ...
                            <tr>
                                ...
                                <td width="5%"></td>
                                <td width="20%" class="pt-1 border-b">00/00/0000</td>
                                <td width="5%"></td>             
                                <td width="20%" class="pt-1 border-b">00/00/0000</td>
                                <td width="5%"></td>
                                <td width="20%" class="pt-1 border-b">Género</td>           
                            </tr>
                        </table>
                    </td>
                </tr>
                    ...
                    <td width="100%">
                        <table style="width:100%;">
                            <tr class="blue-text">
                                <td width="20%">Edad</td>
                                <td width="5%"></td>
                                <td width="85%">Último grado de estudios</td>
                            </tr>
                            <tr>
                                <td width="20%" class="pt-1 border-b">00 años</td>
                                <td width="5%"></td>
                                <td width="85%" class="pt-1 border-b">texto</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr class="input-text">
                    <td width="38%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">000000</td>
                            </tr>
                        </table>
                    </td>
                    <!-- Space -->
                    ...
                    <td width="38%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">0000000000000</td>
                            </tr>
                        </table>
                    </td>
                    <!-- Space -->
                    ...
                    <td width="14%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">O<sup>+</sup></td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr class="input-text">
                    <td width="38%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">Puesto Actual</td>
                            </tr>
                        </table>
                    </td>
                    <!-- Space -->
                    ...
                    <td width="38%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">Adscripción Actual</td>
                            </tr>
                        </table>
                    </td>
                    <!-- Space -->
                    ...
                    <td width="14%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">0 años</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr class="input-text">
                    <td width="40%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">Empleado</td>
                            </tr>
                        </table>
                    </td>
                    <!-- Space -->
                    ...
                    <td width="40%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">$ 00000</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr class="input-text">
                    <td width="30%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">Pago</td>
                            </tr>
                        </table>
                    </td>
                    <!-- Space -->
                    ...
                    <td width="30%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">00/00/0000</td>
                            </tr>
                        </table>
                    </td>
                    <!-- Space -->
                ...
                <tr class="input-text">
                    <td width="40%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">Grado</td>
                            </tr>
                        </table>
                    </td>
                    <!-- Space -->
                    ...
                    <td width="40%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">Situación</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr class="input-text">
                    <td width="40%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">00:00 - 00:00</td>
                            </tr>
                        </table>
                    </td>
                    <!-- Space -->
                    ...
                    <td width="40%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">Soltera(o)</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr class="input-text">
                    <td width="30%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">Si</td>
                            </tr>
                        </table>
                    </td>
                    <!-- Space -->
                ...
                <tr class="input-text">
                    <td width="30%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">Activo</td>
                            </tr>
                        </table>
                    </td>
                    <!-- Space -->
                    ...
                    <td width="30%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">000000000000</td>
                            </tr>
                        </table>
                    </td>
                    <!-- Space -->
                ...
                <tr class="input-text">
                    <td width="40%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">55 0000 0000</td>
                            </tr>
                        </table>
                    </td>
                    <!-- Space -->
                    ...
                    <td width="40%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">ejemplo@ejemplo.com</td>
                            </tr>
                        </table>
                    </td>
                </tr>
                ...
                <tr class="input-text">
                    <td width="30%">
                        <table style="width:100%;">
                            ...
                            <tr>
                                <td width="100%" class="pt-1 border-b">Nombre Nombre Nombre</td>
                            </tr>
                        </table>
                    </td>
                    <!-- Space -->
        ...
        <div class="content">
            ...
            <table style="width:100%;">
                <tr class="input-text">
                    ...
                    <td width="28%" class="border-b pt-2">      Nombre Nombre Nombre</td>
                    <td width="5%"></td>
